...
# Anomaly Detection with Memory Bank
...
def extend_cfg(cfg):
    ...
    # Anomaly Detection with Memory Bank + Lesion Masking
    ...
    cfg.TRAINER.ANOMALY_DETECT.MEMORY_BANK_PATH = "memory_bank.pt"
    ...
    cfg.TRAINER.ANOMALY_DETECT.S_MAX = 8
    cfg.TRAINER.ANOMALY_DETECT.N_MAX = 50
